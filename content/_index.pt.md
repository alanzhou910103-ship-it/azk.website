...
featured_controllers:
  enable: true
  title: Plataformas de controle prontas para competir
  description: Plataformas voltadas ao desempenho para distribuidores, varejistas e marcas gamer, com opções de diferenciação.
  items:
  - name: G17
...
featured_accessories:
  enable: true
  title: Acessórios com potencial de venda
  description: Acessórios para consoles selecionados por sua utilidade, apresentação e possibilidades de personalização.
  items:
  - name: GA05
...
about:
  enable: true
  label: Sobre a INT-ROCK
  title: Experiência de produto em cada detalhe
  content: 'A INT-ROCK é uma empresa de comercialização e desenvolvimento de controles gamer e acessórios que atende distribuidores, varejistas e marcas em todo o mundo.


    Nossa força está no conhecimento do produto, na comunicação com o cliente e na coordenação de recursos. Com mais de 11 anos de experiência, entendemos tanto os detalhes técnicos quanto as necessidades comerciais.


    Trabalhamos com fabricantes, fornecedores de soluções eletrônicas, empresas de moldes e recursos de embalagem. Isso nos permite oferecer desde produtos existentes e personalização OEM/ODM até moldes exclusivos e novos desenvolvimentos.
...
call_to_action:
  enable: true
  title: Vamos desenvolver seu próximo produto gamer
  content: Informe o mercado-alvo, os requisitos e a faixa de preço. Ajudaremos a definir uma opção de produto ou uma rota de desenvolvimento viável.
  button:
    enable: true
    label: Falar sobre seu projeto
    link: "#contact"
